...
<form class="row g-3" action="../controler/alterarUsuario.php" method="post">
  ...
  <div class="col-6">
    ...
    <input type="text" name="foneusu" value="<?=$informa["foneusu"] ?>" class="form-control" id="inputfone" placeholder="55 (--) 91234-5678" required>
  </div>
  <div class="col-6">
    <label for="inputCPF" class="form-label">CPF</label>
    <input type="text" name="cpfusu" value="<?=$informa["cpfusu"] ?>" class="form-control" id="inputCPF" placeholder="123.456.789-00" required>
  </div>
  <div class="col-md-4">
  ...
  <div class="col-4">
    ...
    <input type="text" name="compleusu" value="<?=$informa["compleusu"] ?>" class="form-control" id="inputComple" placeholder="Casa 2">
  </div>
  </div>
  <div class="col-md-6">
